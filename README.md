...
이 프로젝트는 프론트엔드 개발자로써 RAG(Retrieval Augmented Generation) 를 이해하는 용도로 작성한 간단한 테스트용 RAGr 토이 프로젝트입니다. 단순한 LLM API 호출을 넘어서, 벡터 데이터베이스, 임베딩, 컨텍스트 검색 등 RAG 아키텍처의 핵심 요소들을 이해하고 구현하기 위해 개발되었습니다.
